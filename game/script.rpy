...
image FBI movie = Movie(fps=60,play="FBI-Video.webm",loop=False,channel='Movie')
...
label start:
    ...
    play voice "audio/voice/Hi, I'm Aiko, your music playing assistant.ogg"
    C "Hi, I'm Aiko, your music playing assistant."

    play voice "audio/voice/Now, I'll play my favorite song.ogg"
    ...
    if (renpy.music.is_playing(channel='music')):
        ...
        play voice "audio/voice/I'll call FBI to arrest you.ogg"
